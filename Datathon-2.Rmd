...
setwd("D:/R Working Directory/textmining")

#install.packages("rJava")  # download Java 64 bit before installing the package and install package ran from command prompt.
#install.packages("tm")
...
# Do not run the code tm_map(x1,PlainTextDocument) as it is unnecessarily removing the documents
#x1 = tm_map(x1, PlainTextDocument) 
# PlainTextDocument unncesssarily removing all the documents 

# If you get any error containing the word simpletriplet matrix then please run the below code
# and continue executing 
# x1 <- Corpus(VectorSource(X1))
# If you did not get any error then please continue the executing the r code.
...
# If you get any error containing the word simpletriplet matrix then please run the code which is at 218
# and continue executing 
# x1 <- Corpus(VectorSource(X1))
# If you did not get any error then please continue the executing the r code.
